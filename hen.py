...
basket_img = pygame.image.load("basket.png")  # Use actual image
basket_img = pygame.transform.scale(basket_img, (BASKET_WIDTH, BASKET_HEIGHT))

hen_img = pygame.image.load("hen.png")  # Use actual image
hen_img = pygame.transform.scale(hen_img, (HEN_WIDTH, HEN_HEIGHT))

# Load background image or set a background color
background_img = pygame.Surface((SCREEN_WIDTH, SCREEN_HEIGHT))
background_img.fill(BACKGROUND_COLOR)  # Background can be improved with an image if desired
